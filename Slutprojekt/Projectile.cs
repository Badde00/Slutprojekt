...
namespace Slutprojekt
{
    ...
    {   //Valde att skippa size
        ...
        public Projectile(int zPierce, float zSpeed, float zAngle, int zDmg, Texture2D zTex, Vector2 zPos, Rectangle zHitBox, Vector2 zDir, BaseTower zShotFrom)
        {
            isDead = false;
